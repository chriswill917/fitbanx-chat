...
const client = algoliasearch("RSPRNMEQJA", "c1049a4a949f763c42bfaa798b20d7bb"); /*use your own keys*/
const index = client.initIndex('fitbanx-app');

admin.initializeApp({
  credential: admin.credential.cert(serviceAccount),
  databaseURL: "https://react-firebase-project-c94f3.firebaseio.com"
});
